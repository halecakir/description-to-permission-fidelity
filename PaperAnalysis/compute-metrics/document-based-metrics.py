...
class Arguments:
    def __init__(self, permission):
        ...
        self.saved_data = "/Users/huseyinalecakir/huseyin/Work/Security/datasets/saved-parameters/saved-data/ac-net/embeddings-documents-w2i.pickle"
        self.outdir = "document-output_{}.txt".format(permission)
        self.stemmer = "porter"
